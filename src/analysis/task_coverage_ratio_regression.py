...
The significance of 'treath' or 'treatl' shows that the funding program was effective
...
from src.model_code.coverage_ratio_of_firms import regress
        ...
        (
            {
                ...
                / f"{model_name}.json",
                "regression": SRC / "model_code" / "coverage_ratio_of_firms.py",
